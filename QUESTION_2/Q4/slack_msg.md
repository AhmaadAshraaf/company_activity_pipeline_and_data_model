...
- **Post-change visibility:** I’ll add a lightweight daily alert (Slack/Teams) when reconciliation delta for any company/date exceeds the threshold, and share a short runbook for how to request a re-run for a specific date.
